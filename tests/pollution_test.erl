...
get_maximum_gradient_stations_test() ->
  M = pollution:add_station("Stacja 2", {1,3}, pollution:add_station("Stacja 1", {1,1}, pollution:create_monitor())),
  Time = calendar:local_time(),
  M1 = pollution:add_value("Stacja 1", Time, "PM10", 15, M),
  M2 = pollution:add_value("Stacja 2", Time, "PM5", 10, M1),
  ?assertMatch([{2.5,"Stacja 1", "Stacja 2"}],pollution:get_maximum_gradient_stations(1,M2)),
  M3 = pollution:add_value("Stacja 1", Time, "PM5", 15, M2),
  ?assertMatch([{10.0,"Stacja 1", "Stacja 2"}],pollution:get_maximum_gradient_stations(1,M3)),
  M4 = pollution:add_station("Stacja 3", {1,2},M3),
  M5 = pollution:add_value("Stacja 3", {{2023,3,27},{11,16,10}}, "PM2",4,M4),
  ?assertMatch([{26.0,"Stacja 1", "Stacja 3"}],pollution:get_maximum_gradient_stations(1,M5)).
